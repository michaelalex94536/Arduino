...
void setup() {
  Serial.begin(115200);
  if(!display.begin(SH110X_SETCOMPINS))
  {
  ...
  display.clearDisplay();
  //display.drawBitmap(0, 0, electronicshub_logo, SCREEN_WIDTH, SCREEN_HEIGHT, SH110X_WHITE);
  display.display();
  delay(1000);
...
void DrawRectangle()
{
  ...
  display.drawRect(0, 15, 90, 45, SH110X_WHITE);
  display.display();
  delay(2000);
}
...
void DrawFilledRectangle()
{
  ...
  display.fillRect(0, 15, 90, 45, SH110X_WHITE);
  display.display();
  delay(2000);
...
void DrawRoundRectangle()
{
  ...
  display.drawRoundRect(0, 15, 90, 45, 10, SH110X_WHITE);
  display.display();
  delay(2000);
}
...
void DrawFilledRoundRectangle()
{
  ...
  display.fillRoundRect(0, 15, 90, 45, 10, SH110X_WHITE);
  display.display();
  delay(2000);
...
void DrawCircle()
{
  ...
  display.drawCircle(30, 36, 25, SH110X_WHITE);
  display.display();
  delay(2000);
}
...
void DrawBigCircle()
{
  ...
  display.setTextColor(SH110X_WHITE);
  display.setCursor(0,0);
  display.println("Big circle");
  display.drawCircle(60, 72, 50, SH110X_WHITE);
  display.display();
  delay(2000);
}
...
void DrawFilledCircle()
{
  ...
  display.fillCircle(30, 36, 25, SH110X_WHITE);
  display.display();
  delay(2000);
...
void DrawTriangle()
{
  ...
  display.drawTriangle(30, 15, 0, 60, 60, 60, SH110X_WHITE);
  display.display();
  delay(2000);  
}
...
void DrawFilledTriangle()
{
  ...
  display.fillTriangle(30, 15, 0, 60, 60, 60, SH110X_WHITE);
  display.display();
  delay(2000);
}